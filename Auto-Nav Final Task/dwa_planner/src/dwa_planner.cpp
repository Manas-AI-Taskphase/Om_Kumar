      ...
      scan_not_subscribe_count_(0)
{
    ...
    local_nh_.param<double>("TARGET_VELOCITY", target_velocity_, {0.05});
    local_nh_.param<double>("MAX_VELOCITY", max_velocity_, {0.05});
    ...
    local_nh_.param<double>("OBS_RANGE", obs_range_, {0.5});
